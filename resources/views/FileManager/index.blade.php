                                                    ...
                                                    <div class="avatar-group">
                                                        ...
                                                        <div class="avatar-group-item">
                                                            <a href="javascript: void(0);" class="d-inline-block">
                                                                <div class="avatar-xs">
                                                                    <span
                                                                        class="avatar-title rounded-circle bg-success text-white font-size-15">
                                                                        A
                                                                    </span>
                                                                </div>
                                                            </a>
                                                ...
                                                <div class="d-flex mt-3">
                                                    ...
                                                    <div class="align-self-end ms-2">
                                                        <p class="text-muted mb-0 font-size-13"><i
                                                                class="bx bx-time-five align-middle me-1"></i> 15 min ago
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body p-3">
                                            <div class="">
                                                ...
                                                <div class="d-flex mt-3">
                                                    ...
                                                    <div class="align-self-end ms-2">
                                                        <p class="text-muted mb-0 font-size-13"><i
                                                                class="bx bx-time-five align-middle me-1"></i> 23 min ago
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body p-3">
                                            <div class="">
                                                    ...
                                                    <div class="avatar-group">
                                                        <div class="avatar-group-item">
                                                            <a href="javascript: void(0);" class="d-inline-block">
                                                                <div class="avatar-xs">
                                                                    <span
                                                                        class="avatar-title rounded-circle bg-info text-white font-size-15">
                                                                        K
                                                                    </span>
                                                                </div>
                                                            </a>
                                                ...
                                                <div class="d-flex mt-3">
                                                    ...
                                                    <div class="align-self-end ms-2">
                                                        <p class="text-muted mb-0 font-size-13"><i
                                                                class="bx bx-time-five align-middle me-1"></i> 45 min ago
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-1">
                                                        ...
                                                        <a href="" class="font-size-14 text-muted"><u>Con
                                                                Edit</u></a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="avatar-group">
                                                        ...
                                                        <div class="avatar-group-item">
                                                            <a href="javascript: void(0);" class="d-inline-block">
                                                                <div class="avatar-xs">
                                                                    <span
                                                                        class="avatar-title rounded-circle bg-danger text-white font-size-15">
                                                                        3+
                                                                    </span>
                                                                </div>
                                                            </a>
                                                    ...
                                                    <div class="avatar-group">
                                                        <div class="avatar-group-item">
                                                            <a href="javascript: void(0);" class="d-inline-block">
                                                                <div class="avatar-xs">
                                                                    <span
                                                                        class="avatar-title rounded-circle bg-pink text-white font-size-15">
                                                                        L
                                                                    </span>
                                                                </div>
                                                            </a>
                ...
                <div class="d-flex flex-column h-100">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="text-center">
                            <div id="overview"
                                data-colors='["--bs-success", "--bs-danger","--bs-info","--bs-primary", "--bs-warning"]'
